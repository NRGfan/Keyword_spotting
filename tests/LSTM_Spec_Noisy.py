...
class GoogleSpeechCommands():
    ...
    def __getitem__(self, index):
        ...
        mfcc = np.load(path[:-4] + "_SNR" + str(snr_db) + "_whitenoise" + "melspec" + ".npy")[1:12]
...
#model = torch.load(r"C:/Users/user/Desktop/Intern_Joshua/kws_training2/folder/Trained Models/lstm_speechcom_c12_0noise_final.pth", map_location=torch.device('cpu'))
#model.to(device)
...
for i in range(50):
    ...
    ## save model
    path = r"C:/Users/user/Desktop/Intern_Joshua/kws_training2/folder/Trained Models/lstm_speechcom_c12_0noise_final.pth"
